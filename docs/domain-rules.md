...
| Поле                    | Валидно, если              |
| ------------------------| -------------------------- |
| client_approved_limit   | целое число в копейках, ≥0 |
| client_outstanding_debt | целое число в копейках, ≥0 |
| client_reserved_amount  | целое число в копейках, ≥0 |
| product_max_limit       | целое число в копейках, >0 |
| requested_amount        | целое число в копейках, >0 |
